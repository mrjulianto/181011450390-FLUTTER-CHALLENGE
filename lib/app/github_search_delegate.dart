...
class GitHubSearchDelegate extends SearchDelegate<GitHubUser> {
  ...
  Widget buildMatchingSuggestions(BuildContext context) {
    final Map<GitHubAPIError, String> errorMessages = {
      GitHubAPIError.parseError: 'Kesalahan membaca data dari API',
      GitHubAPIError.rateLimitExceeded: 'Batas terlampaui',
      GitHubAPIError.unknownError: 'Kesalahan yang tidak diketahui',
    };
    // then return results
